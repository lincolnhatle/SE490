...
public class MainForm : Form {
	...
	private Color[] colors = { Color.Yellow, Color.Cyan, Color.Magenta, Color.Orange, Color.Pink, Color.DeepSkyBlue, Color.Lime };
	...
	public MainForm() {
		...
		instructions1.Text = "Player 1: Enter key";
	...
	private void NewLevel() {
	   ...
	   if (nLevel == 1) {
		   ...
		   col1 = colors[(nLevel - 1) % colors.Length];
	   }
	   instructions1.ForeColor = col1;
	   RedrawScreen();
	}
